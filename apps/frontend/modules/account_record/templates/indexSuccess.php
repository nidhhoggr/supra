...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('account_record/show?id='.$account_record->getId()) ?>"><?php echo $account_record->getId() ?></a></td>
  ...
  <a href="<?php echo url_for('account_record/new') ?>">New</a>
