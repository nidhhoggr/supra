...
require_once(dirname(__FILE__).'/../lib/BaseClientGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseClientGeneratorHelper.class.php');
 ...
 */
abstract class autoClientActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->client = $this->form->getObject();
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Client'));
    try
    {
      // validate ids
  ...
  {
    return $this->getUser()->getAttribute('client.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('client.filters', $filters, 'admin_module');
  }

  protected function getPager()
  {
    $pager = $this->configuration->getPager('Client');
  ...
  {
    return Doctrine_Core::getTable('Client')->hasColumn($column);
  }
}
