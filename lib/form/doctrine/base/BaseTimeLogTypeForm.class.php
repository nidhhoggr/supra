...
/**
 * TimeLogType form base class.
 *
 * @method TimeLogType getObject() Returns the current form's model object
 *
 * @package    supra
 * @subpackage form
 ...
 */
abstract class BaseTimeLogTypeForm extends BaseFormDoctrine
{
