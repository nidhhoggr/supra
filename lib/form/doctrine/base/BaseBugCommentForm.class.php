...
/**
 * BugComment form base class.
 *
 * @method BugComment getObject() Returns the current form's model object
 *
 * @package    supra
 * @subpackage form
 ...
 */
abstract class BaseBugCommentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'bug_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Bug'), 'required' => false)),
