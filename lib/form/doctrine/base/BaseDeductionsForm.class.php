...
/**
 * Deductions form base class.
 *
 * @method Deductions getObject() Returns the current form's model object
 *
 * @package    supra
 * @subpackage form
 ...
 */
abstract class BaseDeductionsForm extends BaseFormDoctrine
{
