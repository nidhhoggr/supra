...
/**
 * Deduction filter form base class.
 *
 * @package    supra
 * @subpackage filter
 ...
 */
abstract class BaseDeductionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('deduction_filters[%s]');
