...
/**
 * Deductions filter form base class.
 *
 * @package    supra
 * @subpackage filter
 ...
 */
abstract class BaseDeductionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('deductions_filters[%s]');
