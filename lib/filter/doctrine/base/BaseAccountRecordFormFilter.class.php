...
/**
 * AccountRecord filter form base class.
 *
 * @package    supra
 * @subpackage filter
 ...
 */
abstract class BaseAccountRecordFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('account_record_filters[%s]');
