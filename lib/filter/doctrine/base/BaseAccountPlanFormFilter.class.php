...
/**
 * AccountPlan filter form base class.
 *
 * @package    supra
 * @subpackage filter
 ...
 */
abstract class BaseAccountPlanFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('account_plan_filters[%s]');
