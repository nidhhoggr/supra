 ...
 * @property Doctrine_Collection $DeductionsLog
 ...
 * @method Doctrine_Collection getDeductionsLog()  Returns the current record's "DeductionsLog" collection
 ...
 * @method Account             setCredit()         Sets the current record's "credit" value
 ...
 * @method Account             setDeductionsLog()  Sets the current record's "DeductionsLog" collection
...
abstract class BaseAccount extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('credit', 'decimal', null, array(
             'type' => 'decimal',
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('DeductionsLog', array(
             'local' => 'id',
             'foreign' => 'account_id'));
