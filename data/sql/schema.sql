CREATE TABLE account (id BIGINT AUTO_INCREMENT, client_id BIGINT, plan_id BIGINT, title VARCHAR(255), credit DECIMAL(18, 2), domain_name VARCHAR(255), description LONGTEXT, active TINYINT(1) DEFAULT '0' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX client_id_idx (client_id), INDEX plan_id_idx (plan_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE deductions_log (id BIGINT AUTO_INCREMENT, account_id BIGINT, deduced_on DATETIME, INDEX account_id_idx (account_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE staff (id BIGINT AUTO_INCREMENT, user_id BIGINT, firstname VARCHAR(255), lastname VARCHAR(255), title VARCHAR(255), bio LONGTEXT, is_subcontractor TINYINT(1) DEFAULT '0' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE task_log (id BIGINT AUTO_INCREMENT, task_id BIGINT NOT NULL, task_work_id BIGINT NOT NULL, staff_id BIGINT NOT NULL, title VARCHAR(255), description LONGTEXT, gen_desc_id BIGINT, staff_comment LONGTEXT, clock_in DATETIME, clock_out DATETIME, hours_logged DECIMAL(18, 2), mileage DECIMAL(18, 2), percentage BIGINT, is_billable TINYINT(1), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX task_id_idx (task_id), INDEX task_work_id_idx (task_work_id), INDEX staff_id_idx (staff_id), INDEX gen_desc_id_idx (gen_desc_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE account ADD CONSTRAINT account_plan_id_plan_id FOREIGN KEY (plan_id) REFERENCES plan(id);
...
ALTER TABLE deductions_log ADD CONSTRAINT deductions_log_account_id_account_id FOREIGN KEY (account_id) REFERENCES account(id);
