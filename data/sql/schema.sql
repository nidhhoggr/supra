...
CREATE TABLE task_log (id BIGINT AUTO_INCREMENT, task_id BIGINT NOT NULL, task_work_id BIGINT NOT NULL, staff_id BIGINT NOT NULL, title VARCHAR(255), description LONGTEXT, gen_desc_id BIGINT, staff_comment LONGTEXT, clock_in DATETIME, clock_out DATETIME, hours_logged DECIMAL(18, 2), mileage DECIMAL(18, 2), percentage BIGINT, is_billable TINYINT(1) DEFAULT '1' NOT NULL, is_viewable TINYINT(1) DEFAULT '0' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX task_id_idx (task_id), INDEX task_work_id_idx (task_work_id), INDEX staff_id_idx (staff_id), INDEX gen_desc_id_idx (gen_desc_id), PRIMARY KEY(id)) ENGINE = INNODB;
