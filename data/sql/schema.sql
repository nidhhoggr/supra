...
CREATE TABLE staff (id BIGINT AUTO_INCREMENT, user_id BIGINT, title VARCHAR(255), bio LONGTEXT, is_subcontractor TINYINT(1) DEFAULT '0' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
