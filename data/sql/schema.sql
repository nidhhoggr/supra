...
CREATE TABLE task (id BIGINT AUTO_INCREMENT, account_id BIGINT NOT NULL, account_invoice_id BIGINT, staff_id BIGINT, task_status_id BIGINT, task_type_id BIGINT, task_priority_id BIGINT, task_work_id BIGINT, ref_no VARCHAR(255) UNIQUE, name VARCHAR(255), description LONGTEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX account_id_idx (account_id), INDEX account_invoice_id_idx (account_invoice_id), INDEX staff_id_idx (staff_id), INDEX task_status_id_idx (task_status_id), INDEX task_type_id_idx (task_type_id), INDEX task_priority_id_idx (task_priority_id), INDEX task_work_id_idx (task_work_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE task ADD CONSTRAINT task_staff_id_staff_id FOREIGN KEY (staff_id) REFERENCES staff(id) ON DELETE SET NULL;
